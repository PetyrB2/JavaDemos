...
//				tenPrint();
			...
			public static void tenAlt(int total) {
		 ...
		 * }
		 * 
		 * private static void flow(int i, boolean b) { // Flowchart2
		 * 
		 * for(int i = 100, i < 200, i++) { if (i%2 == 0) { b = true;
		 * System.out.println(" __ "); } if (i%2 != 0) { b = false;
		 * System.out.println(" ** "); } while (i <=200);
		 */